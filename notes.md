...
- We attach some helper methods to the Schema which are closly related to that User.
- For User we can create helper method for creating JWT token , for validating the user password etc.
- We create (attach) methods in the user schema.
- Function should be normal function using keyword function , **no arrow fn** as **this** keyword not work in arrow fn.
- It will create more cleaner code
- This is user.js (models/user.js)
...
- In app.js we can use these method like
